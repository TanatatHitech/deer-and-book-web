...
<Select defaultValue={options[0]} options={options} isSearchable={false} />`})})]}),l("div",{className:"panel",id:"nested",children:[l("div",{className:"flex items-center justify-between mb-5",children:[e("h5",{className:"font-semibold text-lg dark:text-white-light",children:"Nested"}),e("button",{type:"button",className:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",onClick:()=>t("code2"),children:l("span",{className:"flex items-center",children:[e(r,{className:"me-2"}),"Code"]})})]}),e("div",{className:"mb-5",children:e(s,{defaultValue:d[1],options:d,isSearchable:!1})}),a.includes("code2")&&e(i,{children:e("pre",{className:"language-typescript",children:`import Select from 'react-select';
...
<Select defaultValue={options1[1]} options={options1} isSearchable={false}/>`})})]}),l("div",{className:"panel",id:"disabling_options",children:[l("div",{className:"flex items-center justify-between mb-5",children:[e("h5",{className:"font-semibold text-lg dark:text-white-light",children:"Disabling options"}),e("button",{type:"button",className:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",onClick:()=>t("code3"),children:l("span",{className:"flex items-center",children:[e(r,{className:"me-2"}),"Code"]})})]}),e("div",{className:"mb-5",children:e(s,{defaultValue:p[0],options:p,isSearchable:!1})}),a.includes("code3")&&e(i,{children:e("pre",{className:"language-typescript",children:`import Select from 'react-select';
...
<Select defaultValue={options2[0]} options={options2} isSearchable={false}/>`})})]}),l("div",{className:"panel",id:"tagging",children:[l("div",{className:"flex items-center justify-between mb-5",children:[e("h5",{className:"font-semibold text-lg dark:text-white-light",children:"Searchable"}),e("button",{type:"button",className:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",onClick:()=>t("code5"),children:l("span",{className:"flex items-center",children:[e(r,{className:"me-2"}),"Code"]})})]}),e("div",{className:"mb-5",children:e(s,{placeholder:"Select an option",options:m})}),a.includes("code5")&&e(i,{children:e("pre",{className:"language-typescript",children:`import Select from 'react-select';
...
<Select placeholder="Select an option" options={options5} isMulti isSearchable={false}/>`})})]})]})]})]})};export{P as default};
