        ...
        <Fragment>
            <div className='min-h-screen flex flex-col lg:hidden bg-gradient-to-b from-[#B347FD] to-[#6789EE] flex items-center justify-center overflow-scroll'>
                ...
                <div className="w-full p-5 flex justify-between items-center">
                    ...
                    <img style={{ height: 20, width: 20 }} className="cursor-pointer" src="/assets/images/icon/share-icon.png" alt="share-icon" onClick={() => navigateToShare(mockBookDetails.slug)}></img>
                </div>
                {/* Modal Container */}
                <div className="bg-white w-auto mx-4 max-w-md rounded-2xl mb-5">
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex justify-center">
                            <img
                                src={mockBookDetails.cover_image}
                                alt="Book Cover"
                        ...
                        {/* Title and Author */}
                        <h3 className="text-center text-lg font-bold mt-4 bg-gradient-to-l from-[#7B77F2] to-[#B446FF] bg-clip-text text-transparent">
                            {mockBookDetails.book_name}
                        </h3>
                        <p className="text-center font-semi-bold text-[#B1B1B1]">Author by {mockBookDetails.author_name}</p>

                        {/* Category Tag */}
                        <div className="flex justify-start mt-2">
                            <span className="px-4 py-1 text-xs font-semibold text-[#864CFC] bg-[#E5D4FD] rounded-md" style={{
