...
const SelectPlan: FC<Props> = (props) => {
    const { t, cropOptions, landData, showSearchPlant, onViewPlan, onViewDetail, onFindPlant, onSubmitSearchPlant, onCloseSearchPlant } = useViewModel(props);
