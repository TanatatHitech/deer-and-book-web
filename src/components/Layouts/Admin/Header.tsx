...
const AdminHeader = () => {
    ...
    const { theme, menu, locale, semidark, languageList, toggleRTL, toggleSidebar, toggleTheme } = useThemeStore(
        useShallow((state) => ({
            theme: state.theme,
            menu: state.menu,
            locale: state.locale,
    ...
    return (
        <header className={`hidden lg:block z-40 ${semidark && menu === 'horizontal' ? 'dark' : ''}`}>
                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300 text-crop-primary">
                                ระบบตรวจสอบ GAP+
                            </span>
                        </Link>
                        <button
                            type="button"
                            className="collapse-icon flex-none dark:text-[#d0d2d6] text-crop-primary hover:text-crop-tertiary dark:hover:text-crop-tertiary flex lg:hidden ltr:ml-2 rtl:mr-2 p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:bg-white-light/90 dark:hover:bg-dark/60"
                            onClick={() => {
                                toggleSidebar(true);
                            }}
                        >
                    ...
                    {/* <div className="ltr:mr-2 rtl:ml-2 hidden sm:block">
                        <ul className="flex items-center space-x-2 rtl:space-x-reverse ">
                            <li>
                                <Link
                                    to="/apps/calendar"
                                    className="block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 text-white hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60"
                                >
                                    <IconCalendar />
                                </Link>
                            </li>
                            ...
                            <li>
                                <Link to="/apps/chat" className="block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 text-white hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60">
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        <div className="sm:ltr:mr-auto sm:rtl:ml-auto w-96">
                            {/* <form
                            ...
                            >
                                <div className="relative">
                                    <input
                                        type="text"
                                        className="form-input ltr:pl-9 rtl:pr-9 ltr:sm:pr-4 rtl:sm:pl-4 ltr:pr-9 rtl:pl-9 peer sm:bg-transparent bg-gray placeholder:tracking-widest text-white placeholder:text-gray-200 border-white focus:border-white"
                                        placeholder="Search..."
                                    />
                                    <button type="button" className="absolute w-9 h-9 inset-0 ltr:right-auto rtl:left-auto appearance-none peer-focus:text-white text-white">
                            ...
                            >
                                <IconSearch className="w-4.5 h-4.5 mx-auto text-white hover:text-primary" />
                            </button> */}
                            {/* <Search placeholder="ค้นหาสิ่งที่คุณต้องการ..." isHeader={true} /> */}
                        </div>
                        {/* <div>
                            {theme === 'light' ? (
                                <button
                                    className={`${
                                        theme === 'light' &&
                                        'flex items-center p-2 rounded-full bg-white-light/40 dark:bg-dark/40 text-white hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60'
                                    }`}
                                    onClick={() => {
                                        toggleTheme('dark');
                                    }}
                        ...
                        {/* <div className="dropdown shrink-0">
                            <Dropdown
                                offset={[0, 8]}
                                placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                                btnClassName="block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 text-white hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60"
                                button={<IconMailDot />}
                            >
                        ...
                        {/* <Link
                            to="/apps/calendar"
                            className="block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 text-crop-primary hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60"
                        >
                            <IconCalendar />
                        </Link> */}
                        {/* <div className="dropdown shrink-0">
                            <Dropdown
                                offset={[0, 8]}
                                placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                                btnClassName="relative block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 text-crop-primary hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60"
                                button={
                                    <span>
                                        <IconBellBing />
                            ...
                            <Dropdown
                                ...
                                button={
                                    <div className="flex items-center gap-4">
                                        <img className="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src="/assets/crop/profile-pic.png" alt="userProfile" />
                                ...
                                <ul className="text-dark dark:text-white-dark !py-0 w-[300px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div className="flex items-center px-4 py-4">
                                            <img className="rounded-md w-10 h-10 object-cover" src="/assets/crop/profile-pic.png" alt="userProfile" />
                                            <div className="ltr:pl-4 rtl:pr-4">
                                                <h4 className="text-base">
                                                    Super Admin<span className="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2">เจ้าหน้าที่</span>
                                                </h4>
                                                <div className="text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white">auditor@mail.com</div>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <Link to="/admin/users" className="dark:hover:text-white">
