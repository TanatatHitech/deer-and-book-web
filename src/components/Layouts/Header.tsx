                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        {/* <Link to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300 text-white">CROP</span>
                        </Link> */}
                        {/* <button
                            type="button"
                            className="collapse-icon flex-none dark:text-[#d0d2d6] text-white hover:text-primary dark:hover:text-primary flex lg:hidden ltr:ml-2 rtl:mr-2 p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:bg-white-light/90 dark:hover:bg-dark/60"
                            onClick={() => {
                                toggleSidebar(true);
                            }}
                        >
                            ...
                            <Dropdown
                                ...
                                button={
                                    <div className="flex items-center">
                                        <img className="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src="/assets/crop/profile-default.jpg" alt="userProfile" />{' '}
                                        <span className="ml-2">{profile.firstName}</span> {/* Update this line */}
                                    </div>
                                }
                            >
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    {/* <li>
                                        <div className="flex items-center px-4 py-4">
                                            <img className="rounded-md w-10 h-10 object-cover" src="/assets/crop/profile-default.jpg" alt="userProfile" />
                                            <div className="ltr:pl-4 rtl:pr-4 truncate">
                                                <h4 className="text-base">
                                                    {profile.firstName} Update this line
                                                </h4>
                                            </div>
                                        </div>
                                    </li> */}
                                    <li className="mt-2">
                                        <Link to="/profile/account" className="dark:hover:text-white">
                                    ...
                                    <li>
                                        <Link to="/land/my-land" className="dark:hover:text-white">
                                            <IconMapPin className="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0" />
                                            ที่ดินของฉัน
                                        </Link>
                                    </li>
