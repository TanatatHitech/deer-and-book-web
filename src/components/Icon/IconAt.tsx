...
const IconAt: FC<IconAtProps> = ({ className, fill = false, duotone = true, onClick }) => {
    return (
        <>
            {!fill ? (
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} onClick={onClick} style={onClick ? { cursor: 'pointer' } : {}}>
                    <path
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} onClick={onClick} style={onClick ? { cursor: 'pointer' } : {}}>
