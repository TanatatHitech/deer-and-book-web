...
interface IconImagePlaceHolderProps {
    className?: string;
}

const IconImagePlaceHolder: FC<IconImagePlaceHolderProps> = ({ className }) => {
    return (
        <Fragment>
            <svg width="800px" height="800px" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
